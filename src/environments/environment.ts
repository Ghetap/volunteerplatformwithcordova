...
export const environment = {
  production: false,
  firebaseApiKey:'AIzaSyAxm9vyjSJVNO-pxfoYfZaF1PPOIhmQQwY',
  firebaseConfig: {
  ...
  vapidKey:"BCLWQgfvZ70BZhasQjl_H9fnkclIYICvg-SzIKQsXqXwanK_gDBjcFuvaY42mtWskkUsg5y75kzSzmcL37yzLN4"
};
/*
